SPEC = Gem::Specification.new do |spec| 
  spec.name = "bcms_webdav"
  spec.rubyforge_project = spec.name
  spec.version = "1.0.0"
  spec.summary = "A Webdav Module for BrowserCMS"
  ...
  spec.files += Dir["lib/bcms_webdav.rb"]
  spec.files += Dir["lib/bcms_webdav/*"]
  spec.files += Dir["rails/init.rb"]
  spec.files += Dir["public/bcms/webdav/**/*"]
  spec.has_rdoc = true
